	...
	if(isset($_SESSION['admin']) && $_SESSION['admin']) {
        echo '<div id="monaccordeon">
                <div class="accordion-group">
                    <button style="margin-left: 40%;" class="btn btn-primary accordion-heading" data-toggle="collapse" data-parent="#monaccordeon" data-target="#item1">
                        Ajouter une série
                    </button>
      ...
      <div class="accordion-group">
            <button style="margin-left: 40%;" class="btn btn-primary accordion-heading" data-toggle="collapse" data-parent="#monaccordeon" data-target="#item2">
            Ajouter un épisode
            </button>
